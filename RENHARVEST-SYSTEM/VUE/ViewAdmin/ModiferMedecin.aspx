<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModiferMedecin.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdmin.ModiferMedecin" %>
                ...
                <div class="right_col" role="main" id="liste">
                    ...
                    <div class="">
                        ...
                        <div class="page-title">
                            <div class="title_left">
                                <br />
                                <h5> Modifier Medecin |</h5>
                            </div>
                             <div class="title_right">
							<div class="col-md-8 col-sm-8 form-group  top_search"><br />
								<div class="input-group">
                                    <asp:TextBox ID="tsearch" runat="server" class="form-control" placeholder="Rechercher..."></asp:TextBox>
