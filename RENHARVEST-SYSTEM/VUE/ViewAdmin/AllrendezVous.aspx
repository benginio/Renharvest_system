<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllrendezVous.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdmin.AllrendezVous" %>
    ...
    <script type="text/javascript">
        function init_calendar() {
            ...
            $.ajax({
                ...
                url: "AllrendezVous.aspx/GetCalendarData",
                dataType: "json",
