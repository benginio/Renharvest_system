<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rapport.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdmin.rapport" %>
             ...
             <div class="table-responsive">
                        <asp:GridView ID="magride" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="codeMalad" EmptyDataText="Pas info a afficher." OnSelectedIndexChanged="Page_Load">
                            ...
                            <Columns>  
                                ...
                                <asp:BoundField DataField="nomMalad" HeaderText="Nom" SortExpression="Nom" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                                <asp:BoundField DataField="nbr fois" HeaderText="Nbr" SortExpression="Prenom" ItemStyle-CssClass="visible-xs" HeaderStyle-CssClass="visible-xs" />  
