<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListeConsultation.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewMedecin.ListeConsultation" %>
            ...
            <!-- /sidebar menu -->
                ...
                <div class="right_col" role="main" id="liste">
                    ...
                    <div class="x_content">
                        ...
                        <asp:GridView ID="magride" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="datecreated" EmptyDataText="Pas info a afficher." OnSelectedIndexChanged="Page_Load">
                            <HeaderStyle BackColor="#34495E" Font-Bold="True" ForeColor="White" />

                            <Columns>  
                               
                            <asp:BoundField DataField="id" HeaderText="code" ReadOnly="True" SortExpression="code" />  
                            ...
                            <asp:BoundField DataField="age" HeaderText="Age" SortExpression="age" HeaderStyle-CssClass="visible-xs" ItemStyle-CssClass="visible-xs" />  
                            <asp:BoundField DataField="motif" HeaderText="Motif" SortExpression="motif" ItemStyle-CssClass="visible-lg" HeaderStyle-CssClass="visible-lg" />  
                            <asp:BoundField DataField="histoire" HeaderText="Histoire" SortExpression="Histoire" ItemStyle-CssClass="visible-lg" HeaderStyle-CssClass="visible-lg" />  
                            <asp:BoundField DataField="signe" HeaderText="Signe" SortExpression="signe" HeaderStyle-CssClass="visible-md" ItemStyle-CssClass="visible-md" />  
                            <asp:BoundField DataField="symptomes" HeaderText="symtomes" SortExpression="symtomes" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                            <asp:BoundField DataField="detail" HeaderText="diagnostique" SortExpression="detail" HeaderStyle-CssClass="visible-md" ItemStyle-CssClass="visible-md" />  
                            <asp:BoundField DataField="comment" HeaderText="note" SortExpression="comment" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
