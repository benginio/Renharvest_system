<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjouterConsultation1.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewMedecin.AjouterConsultation1" %>
                              ...
                              <div class="tab-content " id="Ant-tabContent">
                                  ...
                                  <div class="col-md-4 col-sm-4 pag" id="Allerg">
                                     ...
                                     <div class="form-group row">
                                          <div class="table-responsive">
                                           <asp:GridView ID="Gridantfamille" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="id" EmptyDataText="" OnSelectedIndexChanged="Page_Load">
                                                <HeaderStyle BackColor="#F5F7FA" Font-Bold="True" ForeColor="black" />

                                                <Columns>  
                                                    <asp:BoundField DataField="id" HeaderText="Ant_famille" ReadOnly="True" SortExpression="id" />
                                ...
                                <div class="tab-pane fade pag" id="Ant-profile" role="tabpanel" aria-labelledby="Ant-profile-tab">
                                  ...
                                  <div class="col-md-4 col-sm-4 pag" id="Allerg1">
                                     ...
                                     <div class="form-group row">
                                          <div class="table-responsive">
                                           <asp:GridView ID="Gridpers" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="id" EmptyDataText="" OnSelectedIndexChanged="Page_Load">
                                                <HeaderStyle BackColor="#F5F7FA" Font-Bold="True" ForeColor="black" />
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3">
                      ...
                      <div class="nav nav-tabs flex-column  bar_tabs" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-messages-tab" onclick="menu3()" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><span><i class="fa fa-tint"></i></span> Resultat Examen</a>
                        <a class="nav-link" id="v-pills-settings-tab" onclick="menu4()" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false"><span><i class="fa fa-user-md"></i></span> Consultation</a>
                      </div>
                        ...
                        <div class="tab-pane fade pag" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                            <asp:UpdatePanel runat="server"><ContentTemplate>
                                 <div class="profile_title">
                                      ...
                                      <div class="form-group row">
                                                <div class="col-md-8 col-sm-7 offset-1">
                                                  <label for="inputname">Commentaire</label>
                                                    <asp:TextBox ID="tcomment" TextMode="MultiLine" Rows="3" runat="server" class="form-control" ></asp:TextBox>
                                                </div>
                                        </div>
                                 <div class="form-group row">
                                  <div class="col-md-4 col-sm-4 offset-6">
                                 <asp:LinkButton ID="btnsaveCons" CssClass="btn btn-success" OnClick="btnsaveCons_Click" runat="server">Valider</asp:LinkButton>
                          </div>
                          </div><!--end row-->
                            </ContentTemplate></asp:UpdatePanel>
