`<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjouterConsultation1.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewMedecin.AjouterConsultation1" %><%@ Register Assembly="Microsoft.ReportViewer.WebForms" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="myModalLabel"><span><i class="fa fa-stethoscope"></i></span> Prescription</h4>
