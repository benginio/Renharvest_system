<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifierPatient.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewMedecin.ModifierPatient" %>
    ...
    <script>
        $(function () {
            ...
            $(function swalDefaultSuccess() {
                Toast.fire({
                    icon: 'success',
                    title: 'Modification effectuer avec success!!!  '
                })
            });
