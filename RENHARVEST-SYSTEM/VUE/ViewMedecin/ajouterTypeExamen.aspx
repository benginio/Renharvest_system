<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ajouterTypeExamen.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewMedecin.ajouterTypeExamen" %>
                ...
                <div class="x_panel col-md-12 page" style="background: url('../build/images/bgform3.png');">
                  ...
                  <div class="x_content">
                      <div class="form-group row">
                          <div class="col-md-8 col-sm-8 ">
                               <div class="col-md-4 col-sm-4 ">
                                   <label>Code</label>
                                  <asp:Label ID="tnumTypeEx" class="form-control" placeholder="Code Type Examen..." runat="server" BackColor="#CCCCCC"></asp:Label>
                             </div>
                      <div class="col-md-8 col-sm-8 ">
                          ...
                          <div class="col-md-4 col-sm-4 py-4">
                              ...
                              <asp:LinkButton ID="btnmodifi" CssClass="btn btn-pam" OnClick="btnmodifi_Click" runat="server">Modifier</asp:LinkButton>
                      ...
                      <div class="table-responsive">
                        <asp:GridView ID="magrid" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="numEx" EmptyDataText="Pas info a afficher." OnSelectedIndexChanged="Page_Load">
                            <HeaderStyle BackColor="#34495E" Font-Bold="True" ForeColor="White" />

                            <Columns>  
                                <asp:BoundField DataField="numEx" HeaderText="numExamen" ReadOnly="True" SortExpression="code" />  
