<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListeRDV.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewMedecin.ListeRDV" %>
            ...
            <div class="row">
                <div class="x_panel col-md-12">
                     <div class="x_content">
                        ...
                        <asp:GridView ID="gridlistRDV" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="id" EmptyDataText="Pas info a afficher." OnSelectedIndexChanged="Page_Load">
                            ...
                            <Columns>  
                                ...
                                <ItemTemplate>                            
                                    <asp:LinkButton ID="btnbul" runat="server" Height="30px" CssClass="btn btn-success menu "  OnClientClick="viewprof()" ><span class="me-2"><i class="fa fa-eye"></i></span>Edit</asp:LinkButton> 
                                </ItemTemplate>                         
                             </asp:TemplateField>
                             </Columns> 
