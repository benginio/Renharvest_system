<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ajouterMotifCons.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewMedecin.ajouterMotifCons" %>
          ...
          <div class="">
             ...
             <div class="page-title">
              <div class="title_left"><br/>
                <h5>Ajouter Motif Consultation|</h5>
              </div>
                ...
                <div class="x_panel col-md-12 page" style="background: url('../build/images/bgform3.png');">
                  ...
                  <div class="x_content">
                      <div class="form-group row">
                          <div class="col-md-8 col-sm-8 ">
                              <div class="col-md-4 col-sm-4 ">
                                   <label>Code</label>
                                  <asp:Label ID="tnumMotif" class="form-control" placeholder="num Motif..."  runat="server" BackColor="#CCCCCC"></asp:Label>
                             </div>
                      <div class="col-md-8 col-sm-8 ">
                      ...
                      <div class="table-responsive">
                        <asp:GridView ID="magrid" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="numMotif" EmptyDataText="Pas info a afficher." OnSelectedIndexChanged="Page_Load">
                            <HeaderStyle BackColor="#34495E" Font-Bold="True" ForeColor="White" />

                            <Columns>  
                                <asp:BoundField DataField="numMotif" HeaderText="numMotif" ReadOnly="True" SortExpression="code" />  
                                <asp:BoundField DataField="description" HeaderText="NomMedicament" SortExpression="Nom" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
