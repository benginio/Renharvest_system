                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group row">
                        <div class="col-md-9 col-sm-9  offset-md-4">
                            <asp:Button ID="btnvaliser" class="btn btn-success" runat="server" Text="Enregistrer" OnClick="btnvaliser_Click" />
                          <button class="btn btn-pam" type="reset">Annuler</button>
                        </div>
                      </div>
