<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listehismedicament.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdminSys.Listehismedicament" %>
                ...
                <div class="x_panel col-lg-12">
                    ...
                    <div class="x_content">
                        ...
                        <asp:GridView ID="magride" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="typeAction" EmptyDataText="Pas info a afficher.">
                            ...
                            <Columns>  
                                <asp:BoundField DataField="typeAction" HeaderText="Operation" ReadOnly="True" SortExpression="type" />  
