<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listehispatient.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdminSys.Listehispatient" %>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-user"></i> Utilisateur <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="AjouterUser.aspx">Ajouter</a></li>
                      <li><a href="ModifierUser.aspx">Modifier</a></li>
                      <li><a href="ListerUser.aspx">Lister</a></li>
                      <li><a href="AccessUser.aspx">Access</a></li>
                      
                    </ul>
                  </li>
                    <li><a><i class="fa fa-cogs"></i>Audit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     <li><a href="AjouterPatient.aspx">Hist. Patient</a></li>
                      <li><a href="ModifierPatient.aspx">Hist. Medecin</a></li>
                      <li><a href="ListePatient.aspx">Hist. signe_Vitaux</a></li>
                      <li><a href="ListePatient.aspx">Hist. Consultation</a></li>
                      <li><a href="ListePatient.aspx">Hist. Medicament</a></li>
                      <li><a href="ListePatient.aspx">Hist. Ordonance</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-cogs"></i> Rapport <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">...</a></li>
                      <li><a href="#">...</a></li>
              ...
              <div class="row">
                ...
                <div class="x_panel col-lg-12">
                    ...
                    <div class="x_content">
                        ...
                        <asp:GridView ID="magride" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="typeAction" EmptyDataText="Pas info a afficher.">
                            <HeaderStyle BackColor="#34495E" Font-Bold="True" ForeColor="White" />

                            <Columns>  
                                            <asp:BoundField DataField="typeAction" HeaderText="Operation" SortExpression="type" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                                            <asp:BoundField DataField="codePatient" HeaderText="codePatient" SortExpression="type" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                                            ...
                                            <asp:BoundField DataField="phone" HeaderText="Telephone" SortExpression="Telephone" HeaderStyle-CssClass="visible-md" ItemStyle-CssClass="visible-md" />  
                                            ...
                                            <asp:BoundField DataField="g_s" HeaderText="Groupe_S" SortExpression="Groupe_S." HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                                            <asp:BoundField DataField="p_Respon" HeaderText="Personne_Responsable" SortExpression="Personne_Respnsable" HeaderStyle-CssClass="visible-md" ItemStyle-CssClass="visible-md" />  
                                            <asp:BoundField DataField="lienARespon" HeaderText="Lien_Personne_responsable" SortExpression="Lien_Personne responsable" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
