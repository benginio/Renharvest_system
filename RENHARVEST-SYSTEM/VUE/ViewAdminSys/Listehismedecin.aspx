<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listehismedecin.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdminSys.Listehismedecin" %>
          ...
          <div class="">
             ...
             <div class="page-title">
              <div class="title_left"><br/>
                <h5>historique Liste Patient |</h5>
              </div>
            </div>
                ...
                <div class="x_panel col-lg-12">
                    ...
                    <div class="x_content">
                        ...
                        <asp:GridView ID="magride" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="typeAction" EmptyDataText="Pas info a afficher.">
                            ...
                            <Columns>  
                                            <asp:BoundField DataField="typeAction" HeaderText="Operation" ReadOnly="True" SortExpression="codePatient" />  
                                            <asp:BoundField DataField="codeMedecin" HeaderText="codeMedecin" ReadOnly="True" SortExpression="codePatient" />  
                                            ...
                                            <asp:BoundField DataField="special" HeaderText="specialisation" SortExpression="specialisation" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
