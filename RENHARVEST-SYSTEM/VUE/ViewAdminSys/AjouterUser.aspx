<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjouterUser.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdminSys.AjouterUser" %>
                    ...
                    <div class="form-horizontal form-label-left">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-4 col-sm-4">
                            <label>Type Utilisateur</label>
                              <asp:DropDownList ID="ddtypeuser" class="form-control"  runat="server" style="width: 100%;">
                                    <asp:ListItem>Administrateur</asp:ListItem>
                                    <asp:ListItem>Infirmier(e)</asp:ListItem>
                                    <asp:ListItem>Secretaire</asp:ListItem>
                                    <asp:ListItem>Caissier(e)</asp:ListItem>
                              </asp:DropDownList>
                            </div>
                      ...
                      <div class="form-group row">
                        <div class="col-md-9 col-sm-9  offset-md-4">
                            ...
                            <asp:Button ID="btnannuler" class="btn btn-pam" runat="server" Text="Annuler" OnClick="btnannuler_Click" />
