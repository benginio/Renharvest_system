<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addservice.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdminSys.addservice" %>
<!DOCTYPE html>
                  ...
                  <div class="x_title">
                    <div class="form-group row">
                      <div class="col-md-5 col-sm-5">
                          <asp:TextBox ID="tcodeS" class="form-control" placeholder="Codeservice"  runat="server" Enabled="False"></asp:TextBox>
                        </div> 
                        </div>
                  </div>
                  <div class="x_content">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                          ...
                          <asp:TextBox ID="tdescript" class="form-control" placeholder=""  runat="server" OnTextChanged="tdescript_TextChanged" AutoPostBack="true" ></asp:TextBox>
                        </div>
                              <div class="col-md-6 col-sm-6 ">
                          <label>Prix</label>
                          <asp:TextBox ID="tprix" class="form-control" placeholder=""  runat="server" AutoPostBack="true" ></asp:TextBox>
                        </div>
                        </div><!--end col-8-->
                      ...
                      <div class="table-responsive">
                        <asp:GridView ID="magrid" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="codeMalad" EmptyDataText="Pas info a afficher." OnSelectedIndexChanged="Page_Load">
                            ...
                            <Columns>  
                                <asp:BoundField DataField="codeService" HeaderText="CodeService" ReadOnly="True" SortExpression="code" />  
                                <asp:BoundField DataField="description" HeaderText="Description" SortExpression="Nom" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
