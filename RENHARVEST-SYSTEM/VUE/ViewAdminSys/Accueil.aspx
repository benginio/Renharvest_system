<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accueil.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdminSys.Accueil" %>
               ...
               <a href="Accueil.aspx"> <h2><i class="fa fa-home"></i>Accueil</h2></a>
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-chart-o"></i> Rapport <span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu">
                      <li><a href="sddservice.aspx">Service</a></li>
