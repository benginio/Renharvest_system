<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListerUser.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewAdminSys.ListerUser" %>
                    ...
                    <div class="x_content">
                        ...
                        <asp:GridView ID="magride" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="codepers" EmptyDataText="Pas info a afficher.">
                            ...
                            <Columns>  
                                            ...
                                            <asp:BoundField DataField="pseudo" HeaderText="pseudo" SortExpression="pseudo" HeaderStyle-CssClass="visible-md" ItemStyle-CssClass="visible-md" />  
                                            <asp:BoundField DataField="password" HeaderText="Mot_de_pass" SortExpression="type" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                                            <asp:BoundField DataField="type" HeaderText="type" SortExpression="type" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                                            <asp:BoundField DataField="dateEmbauch" HeaderText="Date_Embauch" SortExpression="date" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
                                            <asp:BoundField DataField="status" HeaderText="status" SortExpression="type" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />  
