<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ajouterrdv.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewPatient.ajouterrdv" %>
        ...
        <div class="modal-content">
              ...
              <form id="antoform" class="form-horizontal calender" role="form">
                  ...
                  <div class="col-sm-9">
                    <%--<input type="text" class="form-control" id="title" name="title">--%>
                      <asp:Label ID="date" class="form-control" runat="server" Text=""></asp:Label>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <%--<input type="text" class="form-control" id="title" name="title">--%>
                      <asp:Label ID="title" class="form-control" name="title" runat="server" Text=""></asp:Label>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <%--<textarea class="form-control" style="height:55px;" id="descr" name="descr"></textarea>--%>
                      <asp:TextBox ID="descr" class="form-control" TextMode="MultiLine" Rows="3"  runat="server"></asp:TextBox>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="modal-footer">
            ...
            <%--<button type="button" class="btn btn-primary antosubmit">Save changes</button>--%>
              <asp:Button ID="Button1" class="btn btn-pam antosubmit" runat="server" Text="Valider" />
          </div>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript">
        function init_calendar() {
            ...
            $.ajax({
                ...
                url: "ajouterrdv.aspx/GetCalendarData",
                dataType: "json",
                    ...
                    var calendar = $('#calendar').fullCalendar({
                        ...
                        select: function (start, end, allDay) {
                            ...
                            $(".antosubmit").on("click", function () {
                                ...
                                $('#title').val('');
                                $('#date').text("Selected Date : " + moment(start).format('DD/MM/YYYY'));
