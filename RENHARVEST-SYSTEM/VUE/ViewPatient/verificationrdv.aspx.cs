...
{
    public partial class verificationrdv : System.Web.UI.Page
    {
        ...
        private static List<CalendarEvents> GetCalendarDataFromDatabase()
        {
            ...
            {
                string strQuery = "Select * FROM tbrendez_vous WHERE codepatient='" + codeP + "' ";
