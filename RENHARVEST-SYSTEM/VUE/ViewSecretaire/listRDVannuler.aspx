<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listRDVannuler.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewSecretaire.AnnulerRDV" %>
                ...
                <div class="right_col" role="main" id="liste">
                    ...
                    <div class="">
                        ...
                        <div class="page-title">
                            <div class="title_left">
                                <br />
                                <h5> Liste Rendez-vous Annuler |</h5>
                            </div>
                        ...
                        <asp:GridView ID="magride" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="id" EmptyDataText="Pas info a afficher." OnSelectedIndexChanged="Page_Load">
                            ...
                            <Columns>  
                                <asp:TemplateField HeaderText="-->">                       
                                    <ItemTemplate>                            
                                        <asp:LinkButton ID="btnbul" runat="server" Height="30px" CssClass="btn btn-danger menu " OnClick="btnbul_Click" ><span class="me-2"><i class="fa fa-trash-o"></i></span></asp:LinkButton> 
                                        <asp:LinkButton ID="btnreturn" runat="server" Height="30px" CssClass="btn btn-success menu " OnClientClick="viewprof()" OnClick="btnreturn_Click" ><span class="me-2"><i class="fa fa-refresh"></i></span></asp:LinkButton> 
                                    </ItemTemplate> 
