<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="planningMedecin1.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewSecretaire.planningMedecin1" %>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                      ...
                      <asp:LinkButton ID="btnlogout" runat="server" class="dropdown-item" OnClick="btnlogout_Click1"><i class="fa fa-sign-out pull-right"></i> Log Out</asp:LinkButton>
    ...
    <script type="text/javascript">
        function init_calendar() {
            ...
            $.ajax({
                ...
                url: "planningMedecin1.aspx/GetCalendarData",
                dataType: "json",
