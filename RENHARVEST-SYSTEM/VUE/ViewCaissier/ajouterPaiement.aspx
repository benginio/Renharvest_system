<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ajouterPaiement.aspx.cs" Inherits="RENHARVEST_SYSTEM.VUE.ViewCaissier.ajouterPaiement" %>
...
<body class="nav-md">
    <form id="form1" runat="server" methode="post">
      ...
      <div class="main_container">
              ...
              <div class="menu_section">
               <a href="Accueil.aspx"> <h2><i class="fa fa-home"></i>Accueil</h2></a>
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cog"></i> Parametre <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">...</a></li>
                      <li><a href="#">...</a></li>
                      <li><a href="#">..</a></li>
        ...
        <!-- page content -->
        <div class="right_col page" role="main" id="paie">
          <div class="">
            ...
            <div class="x_panel col-lg-12">
                        <div class="x_title">
                            <h5><strong>Nom: </strong> <asp:Label ID="lblnom" runat="server" Text="Label"></asp:Label> </h5>
                        </div>
                        <div  id="addpay">
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1"><ContentTemplate>
                                    <div class="form-group row">
                                        <div class="col-md-6 col-sm-6">
                                            <asp:DropDownList ID="ddservice" OnSelectedIndexChanged="ddservice_SelectedIndexChanged" runat="server" AutoPostBack="true"></asp:DropDownList>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <asp:Label ID="tprix" runat="server" Text="Label"></asp:Label>
                                         </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-6 col-sm-6">
                                            <asp:DropDownList ID="ddmodeP" runat="server"></asp:DropDownList>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <asp:TextBox ID="montantP" runat="server"></asp:TextBox>
                                         </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-6 col-sm-6">
                                             <asp:TextBox ID="monnaie" runat="server"></asp:TextBox>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                        ...
                        <div class="row page" id="printpay">
   ...
   <script src="../vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function viewprof() {
            ...
            document.getElementById('paie').style.display = 'block';
        }
        function viewliste() {
            document.getElementById('liste').style.display = 'block';

            document.getElementById('paie').style.display = 'none';
        }
        function viewcarte() {
            document.getElementById('liste').style.display = 'none';
